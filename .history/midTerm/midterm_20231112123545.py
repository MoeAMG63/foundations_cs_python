...
while True:
    if choice == 1:
        ...
        index_of = input("Enter the number of the Tab you want to close (or press Enter to close the last tab): ")
        CloseTab(open_tabs, index1)
